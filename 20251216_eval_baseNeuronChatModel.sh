...
EXPERIMENTS=(
    ...
    "('/root/autodl-fs/model_zoo/meta-llama/Llama-2-7b-chat-hf' 'belebele_vie_Latn' '/root/autodl-fs/llm_eval/test_eval_org_model_chat_belebele_vie_Latn' '5')"
    "('/root/autodl-tmp/llama2_7b_chat_BaseNeuron_ChatMask_lang_en' 'belebele_vie_Latn' '/root/autodl-fs/llm_eval/test_eval_LAPE_llama2_7b_chat_BaseNeuron_ChatMask_lang_en_belebele_vi' '5')"
    "('/root/autodl-tmp/llama2_7b_chat_BaseNeuron_ChatMask_lang_vi' 'belebele_vie_Latn' '/root/autodl-fs/llm_eval/test_eval_LAPE_llama2_7b_chat_BaseNeuron_ChatMask_lang_vi_belebele_vi' '5')"
    "('/root/autodl-tmp/llama2_7b_chat_BaseNeuron_ChatMask_lang_zh' 'belebele_vie_Latn' '/root/autodl-fs/llm_eval/test_eval_LAPE_llama2_7b_chat_BaseNeuron_ChatMask_lang_zh_belebele_vi' '5')"
    "('/root/autodl-fs/model_zoo/meta-llama/Llama-2-7b-chat-hf' 'ceval-valid' '/root/autodl-fs/llm_eval/test_eval_org_model_chat_ceval-valid' '5')"
    "('/root/autodl-tmp/llama2_7b_chat_BaseNeuron_ChatMask_lang_en' 'ceval-valid' '/root/autodl-fs/llm_eval/test_eval_LAPE_llama2_7b_chat_BaseNeuron_ChatMask_lang_en_ceval-valid' '5')"
    "('/root/autodl-tmp/llama2_7b_chat_BaseNeuron_ChatMask_lang_vi' 'ceval-valid' '/root/autodl-fs/llm_eval/test_eval_LAPE_llama2_7b_chat_BaseNeuron_ChatMask_lang_vi_ceval-valid' '5')"
    "('/root/autodl-tmp/llama2_7b_chat_BaseNeuron_ChatMask_lang_zh' 'ceval-valid' '/root/autodl-fs/llm_eval/test_eval_LAPE_llama2_7b_chat_BaseNeuron_ChatMask_lang_zh_ceval-valid' '5')"
    "('/root/autodl-fs/model_zoo/meta-llama/Llama-2-7b-chat-hf' 'mmlu' '/root/autodl-fs/llm_eval/test_eval_org_model_chat_mmlu' '5')"
    "('/root/autodl-tmp/llama2_7b_chat_BaseNeuron_ChatMask_lang_en' 'mmlu' '/root/autodl-fs/llm_eval/test_eval_LAPE_llama2_7b_chat_BaseNeuron_ChatMask_lang_en_mmlu' '5')"
    "('/root/autodl-tmp/llama2_7b_chat_BaseNeuron_ChatMask_lang_vi' 'mmlu' '/root/autodl-fs/llm_eval/test_eval_LAPE_llama2_7b_chat_BaseNeuron_ChatMask_lang_vi_mmlu' '5')"
    "('/root/autodl-tmp/llama2_7b_chat_BaseNeuron_ChatMask_lang_zh' 'mmlu' '/root/autodl-fs/llm_eval/test_eval_LAPE_llama2_7b_chat_BaseNeuron_ChatMask_lang_zh_mmlu' '5')"
