...
EXPERIMENTS=(
   ...
   # "('/root/autodl-fs/model_zoo/meta-llama/Llama-2-7b-hf' 'global_mmlu_vi' '/root/autodl-fs/llm_eval/test_eval_org_model_global_mmlu_vi' '5')"
    ...
    "('/root/autodl-tmp/llama2_7b_base_BaseNeuron_BaseMask_lang_zh' 'global_mmlu_full_vi' '/root/autodl-fs/llm_eval/test_eval_LAPE_llama2_7b_base_BaseNeuron_BaseMask_lang_zh_global_mmlu_vi' '5')"
    ...
    "('/root/autodl-tmp/llama2_7b_base_BaseNeuron_BaseMask_lang_en' 'global_mmlu_full_vi' '/root/autodl-fs/llm_eval/test_eval_LAPE_llama2_7b_base_BaseNeuron_BaseMask_lang_en_global_mmlu_vi' '5')"
    ...
    "('/root/autodl-tmp/llama2_7b_base_BaseNeuron_BaseMask_lang_vi' 'global_mmlu_full_vi' '/root/autodl-fs/llm_eval/test_eval_LAPE_llama2_7b_base_BaseNeuron_BaseMask_lang_vi_global_mmlu_vi' '5')"
