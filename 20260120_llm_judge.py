...
if False:
    ...
    os.environ['OPENAI_API_KEY'] = ""
    client = AsyncOpenAI(
        base_url='https://api.sharedai.chat/v1/chat/completions',
    )
...
input_file ='/root/autodl-fs/LRP/open_ended_data_generation/20260119_newrandom5000samples_cal_llama2_7b_base_random_mask_0_1_2_total/20260119_generation_all_models.json' #'/home/work/lyf-sg-duo/multilingual-evaluation-pipeline/20251021_query.json'

model_name='gpt-5-mini'#'gpt-4o-2024-05-13'#'gpt-5'
output_file = input_file+'_'+model_name+'.json'

#f'/home/work/lyf-sg-duo/multilingual-evaluation-pipeline/lrp_judege/20260119_generation_all_models_random_mask0_1_2.json_gpt4o.json'
